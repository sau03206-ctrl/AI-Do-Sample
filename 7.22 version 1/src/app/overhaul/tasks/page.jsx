...
import { Card, Button, Icon, StatusChip, FieldChip, Avatar, EmptyState, ProgressBar } from "@/components/overhaul/ui";
import { useStore } from "@/lib/overhaul/store";
import { taskProgress, scheduleInfo, overallProgress } from "@/lib/overhaul/progress";
import { scheduleDelayTasks } from "@/lib/overhaul/schedule";
    ...
    <>
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          {can.edit && (
            <Button onClick={() => router.push("/overhaul/upload")}>
