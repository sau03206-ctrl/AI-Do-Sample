...
import { Card, Button, Icon, StatusChip, FieldChip, ProgressBar, EmptyState } from "@/components/overhaul/ui";
import { useStore } from "@/lib/overhaul/store";
import { taskProgress, taskStatus } from "@/lib/overhaul/progress";
...
function PerformanceEntryInner() {
  ...
  const selectedId = searchParams.get("task") || tasks[0]?.id;
